...
public class TerrainGeneration : MonoBehaviour 
{
    ...
    void Start () 
	{
        ...
        //use this statement for testing, since it has particular values that will produce a closed-loop path that cyli and CAPS will traverse
        //originate = new Vector3(65.78028f, 0, 28.30647f);  //be sure to comment-out the next statement if this one is uncommented!
